                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static">
                            <a href='/stages_/stages/demandes/<?php echo $row["nom_pdf"]; ?>'><?php echo $row["nom_pdf"]; ?></a>
                        </p>
                    </div>
                    <div class="form-group">
                    ...
                    <p><a href="demande_stage-index.php" class="btn btn-primary">Liste des demandes de stage</a></p>
                </div>
            </div>
        </div>
    </section>
