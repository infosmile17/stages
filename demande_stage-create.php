...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO demande_stage (id_etudiant,nom_pdf,date_demande,date_reponse,etat) VALUES (?,?,?,?,?)");

    if ($stmt->execute([$id_etudiant, $nom_pdf, $date_demande, $date_reponse, $etat])) {
        $stmt = null;
        header("location: demande_stage-index.php");
    } else {
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="page-header">
                    <h2>Créer une demande de stage</h2>
                </div>
                <p>.</p>
